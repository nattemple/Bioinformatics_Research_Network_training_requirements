...
# convert to factor
rse_gene$cond <- factor(rse_gene$cond)
...
# first replicate has higher initial PAX3
#SRR1614280       SRR1614283 GENENAME
#1 15617.6538464749 14864.7579475358     PAX3


# now check fold change of wt-myod over untreated by replicate

# for simplicity, run twice once on each replicate

#rse1 <- rse_gene
#rse1 <- rse1[,rse1$sample %in% c("SRS722893", "SRS722894")]

#aaa

#dds <- DESeqDataSet(rse1, design = ~ cond)
#dds <- DESeq(dds)
