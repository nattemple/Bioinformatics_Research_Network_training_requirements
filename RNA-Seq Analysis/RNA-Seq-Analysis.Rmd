...
We have grouped wild-type MyoD (wt-MyoD) and generically enhanced (vp64-MyoD) into `treated` buckets and compared to `untreated` cell samples 
...
The Volcano plot allows us to visualize genes along according to their statistical significance (p-value) and their fold change in treated vs. untreated samples:
