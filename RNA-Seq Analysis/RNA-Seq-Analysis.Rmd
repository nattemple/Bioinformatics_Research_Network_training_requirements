  ...
  rse <-
    subset(rse
           , select = colData(rse)$cond %in% 
             c("Simple_intestinal_metaplasia", "High_Grade_Dsyplasia"))
}  
  # Simple_intestinal_metaplasia
  # High_Grade_Dsyplasia
  # Low_Grade_Dsyplasia
